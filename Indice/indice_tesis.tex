...
%\title{Guia Practica Instalación de MinSoc}}
...
%\section{Perspectiva Historica}}
%	\subsection{El Comienzo de los Microprocesadores}}
%	\subsection{FPGAs y Microsprocesadores Soft-Core}}
%	\subsection{Software OpenSource y Libre}}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%CAPITULO 2%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{FPGA y microprocesadores Soft-Core}}%julius
	\subsection{FPGAs}}
...
Benchmarking se asocia generalmente con la evaluación de las características de rendimiento de hardware , por ejemplo , el rendimiento de punto flotante de funcionamiento de una CPU , pero hay circunstancias en que la técnica también es aplicable al software . Puntos de referencia de software están , por ejemplo, van en contra de los compiladores o sistemas de gestión de bases de datos .
	...
	\subsection{CPU core benchmarking}}
...
\section{Software OpenSource y Libre}}%julius
...
Un sitio web, con sus comienzos en el año 2000, llamado OpenCores que proporcionar un sitio para la comunidad de hardware de código abierto. Fue una de las primeras comunidades de desarrollo de hardware y actualmente la mas grande, con más de cien mil usuarios y cerca de mil proyectos. Donde su principal objetivo es diseñar y publicar diseños de núcleo bajo una licencia de hardware siguiendo el modelo de la Licencia LGPL para el software. Estan comprometidos con el ideal de libre disposición, de libre uso y hardware de código abierto reutilizable.%\cita{}www.opencore
		...
		\subsection{Motivación para la adopción del OpenSource}}
...
produciendo el aumento del software existente evitando la tarea de empezar a desarrollar desde cero o comprar una solución propietaria. 
 ...
 Estas son algunas de las motivaciones para la adopción y contribución de código abierto podrían ser muchas más y variadas eso dependerá de la funcionalidad del proyecto de codigo fuente. A pesar de su éxito en el software en el diseño de hardware de código abierto  no tuvo el mismo éxitos los motivos se estudiar más adelante.
		...
		\subsection{Desventajas de la adopción del OpenSource}}
...
based on the innovation, rather than the accessibility, of the design.
		...
		\subsection{Mas motivación para la adopción para el desarrollo OpenSource}}
...
La apertura del código de la propiedad intelectual desarrollada para el proyecto OpenRISC, y otros en OpenCores, ha sido a la vez un obstáculo y una ayuda, ya que pone al desnudo el estado del desarrollo, pero es útil, ya que permite que cualquiera pueda participar en el continuo desarrollo de núcleos. Esta subsección discutirá los pros y los contras de la fuente abierta enfoque.
		...
		\subsubsection{No verificado y No populares}} 
...
Un soft-core processor o abreviado SCP, también llamado soft microprocessor o soft 
processor, es un microprocesador que puede ser implementado utilizando síntesis lógica en  diferentes dispositivos lógicos programables como CPLDs o FPGAs, o incluso puede ser incluido en un diseño para ASIC %\cita{}(37).
 Suelen ser distribuidos en forma de código fuente en algún lenguaje de descripción de hardware, principalmente VHDL o Verilog, aunque  algunos SCPs comerciales se distribuyen en formatos propietarios. 
Los principales fabricantes de dispositivos lógicos programables como se dijo en capitulos anteriores tienen su propio  SCP comercial especialmente diseñado y optimizado para funcionar en sus propias 
FPGAs. Así Xilinx tiene el PicoBlaze %\cita{}(38) 
y el MicroBlaze (39), Altera proporciona el Nios 
II (40), y Lattice distribuye su LatticeMico32 (41). 
También existen una gran variedad de SCPs distribuidos en forma de código 
abierto, como el OpenRISC 1200 (42) mantenido por la comunidad Opencores (43), o los 
SCPs LEON2 y LEON3 (44) (45) que proporciona la compañía Gaisler Research (46).
...
A continuación se presentan más detalladamente las características de estos SCPs, y un resumen comparativo de sus características
	...
	\begin{figure}[h!]
 	\begin{center}
  	%\includegraphics[width=0.5\textwidth,keepaspectratio=true]{./images/estructurapico}
...
\section{Análisis de el OpenRISC }}
		\subsection{Arquitectura}}
		\subsection{Implementación}}
			\subsubsection{ORPSoC}}
			\subsubsection{MinSoc}}
...
\section{Estudio del Problema}}
	...
	\subsection{Requerimientos del Usuario}}
			\subsubsection{En cuanto al Hardware}}
			\subsubsection{En cuanto al las licencias}} 
			\subsubsection{En cuanto Sistema Operativo}} 	 
				 		\subsection{Estudio de componentes y de la viabilidad para el proyecto}}	
		\subsubsection{Objetivo}} 	 
		\subsubsection{Comparación de los Soft-Core}} 
	 	\subsection{Conclusiones de la elección del micro Soft-Core}}
 		\subsubsection{Placas de Desarrollo}}
			\paragraph{Xilinx}}
			\paragraph{Digilent}} 	 
			\paragraph{Altera}}
 		\subsubsection{CONCLUSIONES DE LA ELECCIÓN DE LA PLACA DE DESARROLLO}}
 		\subsubsection{SELECCIÓN DE LAS HERRAMIENTAS DE DESARROLLO}} 	 
 		\subsubsection{Elección de Sistema Operativo}}
%\paragraph{}}
			
\section{Requerimientos y Riesgos Del Sistema}}
...
%Criterios para la realización de testing  (o algo asi) -- PABLO JULIUS :P
	...
	\subsection{Entorno de ejecución}}
		\subsubsection{Entorno de ejecución Standalone}}
		\subsubsection{Entorno de ejecución linux}}
	\subsection{PROTOTIPO UNO: Implementación del SoC MinSoc en FPGA}}
		\subsubsection{Introducción}}
		\subsubsection{Requerimientos del prototipo}}
		\subsubsection{Implementación}}
			\subsubsection{Diagrama de Secuencia}}
			\subsubsection{Testing}}
		\subsection{Conclusión}}
	\subsection{PROTOTIPO DOS: Implementación del SoC OrpSoc en FPGA}}
		\subsubsection{Introducción}}
		\subsubsection{Requerimientos del prototipo}}
		\subsubsection{Implementación}}
			\subsubsection{Diagrama de Secuencia}}
			\subsubsection{Testing}}
		\subsection{Conclusión}}
	\subsection{PROTOTIPO TRES: Implementación del SoC OrpSoc en FPGA con Sistema Operativo eCos}}
		\subsubsection{Introducción}}
		\subsubsection{Requerimientos del prototipo}}
		\subsubsection{Implementación}}
			\subsubsection{Diagrama de Secuencia}}
			\subsubsection{Testing}}
		\subsection{Conclusión}}
	\subsection{PROTOTIPO tres: Implementación OrpSoc en FPGA con Linux}}
		\subsubsection{Introducción}}
		\subsubsection{Requerimientos del prototipo}}
		\subsubsection{Implementación}}
			\subsubsection{Diagrama de Secuencia}}
