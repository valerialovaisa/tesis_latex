...
La facilidad de adaptación del proyecto para portarse a otras arquitecturas reconfigurables le confiere gran versatilidad
...
Teniendo en cuenta los datos obtenidos y la facilidad de adaptación del proyecto para portarse a otras arquitecturas reconfigurables, se pueden aproximar los límites de aplicación del proyecto para una futura elección en otras placas que representen menor costo para ser usadas en aplicaciones reales.
