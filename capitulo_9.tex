\chapter{Implementación y Diseño}
	...
	\section{PROTOTIPO UNO: Implementación del SoC MinSoC en FPGA}
		...
		\begin{figure}[!h]
 		\begin{center}
  		\includegraphics[width=0.8\textwidth,keepaspectratio=true]{./images/minsoc}
		...
		Como primer programa de prueba se realizó un multiplicador de matrices binarias generadas mediante una Secuencia binaria pseudo aleatoria (PRBS).  
