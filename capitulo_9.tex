...
\end{lstlisting}
	...
	\section{PROTOTIPO CUATRO: Implementación del SoC ORPSoC en FPGA con Sistema Operativos Linux}
		...
		\hline 								RQX-PD 4 & El prototipo debe tener capacidad de ejecución y depuración de aplicaciones sobre el sistema operativo Linux\\
		\end{tabular}
		\end{table}
...
\subsection{Matriz de Riesgo para el Prototipo Cuatro} 
		...
		\hline 
		\rowcolor[gray]{0.8} Riesgo & Consecuencia & Estrategia preventiva & Estrategia de contingencia\\
		\hline Fallas en la generación de la imagen del SO para ser montada en el SoC & 
		...
		\hline Falta de documentación de apoyo para la implentación del SO para la arquitectura OpenRISC & 
		...
		\hline Limitaciones para la ejecución de SO  & 
			   Imposibilidad de ejecutar apliaciones desarrolladas para Linux & 
		       Análisis previo de limitaciones en la documentación de los desarrolladores y guías de resolución de problemas & 
		       Revisión y desarrollo de código del SO necesario su funcionamiento\\
