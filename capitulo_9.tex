...
%\end{lstlisting}		
		...
		imágen y sus herramientas (Busybox). Luego, se ejecutó el kernel sobre el simulador de la arquitectura OpenRISC conocido como or1ksim. Pudo
		...
		Como alternativa que permita resolver este problema se recurrió a la documentación, foros y mail lists de las comunidades Opensource. Es importante
		...
		la adapatación del SO a la placa de desarrollo. Si lo mencionado anteriormente no logra resolver el problema, deberá realizar un estudio de
