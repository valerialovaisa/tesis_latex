...
\subsection{Objetivo específico}
  \begin{itemize}
 \item Analizar los microprecesadores soft core disponibles.
 \item Analizar las placas de desarrollo con FPGA disponibles para la implemantación de los microprecesadores analizados.
  \item Seleccionar el microprocesador mas adecuado a nuestros requerimientos y en base a esto seleccionar la placa adecuada.

y su factibilidad de implementación en tales placas. determinar la factibilidad de implementación de microprocesador, seleccionando el mas adecuado para tal FPGA en particular %%corregir agregar plcas disponibles en cudar

 \end{itemize}
\subsection{Objetivo específico}
  \begin{itemize}
  \item Seleccionar, analizar y determinar la factibilidad de implementación de un microprocesador softcore en FPGA.
  \item  Analizar los microprecesadores soft core disponibles y su factibilidad de implementación en tales placas. determinar la factibilidad de
  implementación de microprocesador, seleccionando el mas adecuado para tal FPGA en particular %%corregir agregar plcas disponibles en cudar
