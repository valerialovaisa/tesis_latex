...
\section{Selección del SoC}
				\subsubsection{Descripciones de proyectos SoC con procesador OpenRisc} 
...
El proyecto tiene que ser lo suficientemente fácil para los usuarios, tanto nuevos como experimentados, para empezar con diseños OpenRISC y desarrollar de forma rápida para colaborar fácilmente.

Está destinado a ser un entorno de desarrollo y verificación de núcleos de propiedad intelectual y los diseños SoC. Se trata de un proyecto de colaboración desarrollado.
                 Como plataforma de desarrollo debe proporcionar un fácil de usar entorno modular, para llevar a cabo el desarrollo de RTL con la simulación de botón
                 y fluye síntesis. Un entorno de base de compilación de software también está presente para apoyar el desarrollo OpenRISC en la simulación y en el blanco.
                 El proyecto debe ser lo suficientemente fácil para los usuarios, tanto nuevos como experimentados, para empezar con diseños OpenRISC y desarrollar de forma rápida y
                 colaborar fácilmente.
				. It is intended to be a development and verification environment for IP cores and SoC designs. It is a collaboratively developed project.
		...
		\subsection{Selección del Micro}

	 \subsection{Selección del SoC}
				\subsection{Comparación de proyectos SoC con procesador OpenRisc}

 		\section{Selección de la Placa de Desarrollo}
 				\subsection{Análisis de las alternativas} 
