\documentclass[a4paper,twoside,opemright,12pt]{report}
...
\hyphenation{sis-te-má-ti-co pa-leo-lí-ti-co con-ti-nua-men-te pe-ri-fé-ri-co de-sa-rro-lla-do-res pro-ble-mas fa-bri-can-te exis-ten o-pe-ra-ban}
...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[LO]{ Roberto Pablo Gomez - Valeria Lovaisa Michelini}
\fancyfoot[RO]{P\'agina: \thepage} %\fancyfoot[LE,RO]{P\'agina: \thepage}                               
\fancyfoot[RE]{ Roberto Pablo Gomez - Valeria Lovaisa Michelini}
\fancyfoot[LE]{P\'agina: \thepage} %\fancyfoot[LE,RO]{P\'agina: \thepage}
...
\author{\vspace{-0.25cm} Autores \vspace{0.25cm}\\ Roberto Pablo Gomez - Valeria Lovaisa Michelini \bigskip \bigskip \bigskip \\
  Tema \vspace{0.25cm} \\ \textbf{Implementación de un Sistema en Chip con Microprocesador  }\\ \textbf{ Soft-Core y Soporte Linux/eCos} \\ \textbf{}
...
\bibitem{Etiqueta27}Eclipse. \url{http://www.eclipse.org/}.
...
\bibitem{rte.se} Realtime Embedded, Sven Andersson, Mar 2012 
 \url{http://www.rte.se/}.

\bibitem{denano} Kevin Mahall , Oct 2012
...
\bibitem{etiqueta_OptGcc} GCC - Online Documentation - Optimize Options
\url {http://gcc.gnu.org/onlinedocs/gcc/Optimize-Options.html} 

\bibitem{compcoremark} CoreMark  - Online Documentation
\url {http://www.eembc.org/coremark/} 

\bibitem{compcdhr} Dhrystone  - Online Documentation
\url {http://www.roylongbottom.org.uk/dhrystone%20results.htm} 
