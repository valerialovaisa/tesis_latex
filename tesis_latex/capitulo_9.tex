...
%\end{lstlisting}		
		...
		resultados satisfactorios. %Si se pretende obtener solución a este problema, será necesario realizar un análisis exhaustivo del módulo IP SPI implementado en el proyecto ORPSoC.
