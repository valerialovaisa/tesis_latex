...
En informática, \textit{benchmark} es una medida para medir el rendimiento de un sistema o los componentes del mismo, se obtiene por la acción de ejecutar un
