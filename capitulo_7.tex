\chapter{Analisis Requerimientos y Riesgos}
	...
	\section{Análisis de Riesgo}
		...
		una ponderación entre los riegos detectados.
		...
		\hline 
		\rowcolor[gray]{0.8} N\textordmasculine Req & Riegos Asociados & Severidad  & Ocurrencia & Orden de riesgo \\
		\hline
		...
		\hline
				& Librerías necesarias inexistentes o con fallos & Severo &  Probable & 3\\
		\hline
		RQX-SO 2& Incapacidad de ejecución de hilos en los SO compatibles con el microprocesador elegido & Catastróficos & Improbable & 4\\
		\hline
		...
		En base a la tabla se pueden establecer los requerimientos que involucran mayor riego de implementación listados a continuación:
