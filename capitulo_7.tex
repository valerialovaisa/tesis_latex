	...
	\section{Estudio de componentes y viabilidad para el proyecto}
			...
			\subsection{Selección del Microprocesador Soft-Core}
 			...
 			\subsection{Selección de la Placa de Desarrollo}
				...
				\subparagraph{ML501}
				La ML501 es una plataforma de desarrollo de bajo costo y gran funcionalidad que provee un acceso práctico a los recursos dispobibles en el
			...
			\end{tabular}
				...
				Las implementación ORPSoC fue probada con éxito en esta plataforma y provee soporte para los siguientes perisféricos:
				...
				LX45. Posee perisféricos entre los que se destacan Gbit Ethernet, Video HDMI, Audio, puertos USB y Memoria Ram 128 MB DDR2 que permiten el
				desarrollo de Sistemas Digitales sobre procesadores embebidos como  MicroBlaze de Xilinx. Atlys es compatible con todas las herrmientas CAD de
				...
				La implementación ORPSoC proveen soporte nativo para los siguientes perisféricos:
				...
				utilización de hardware extra. Los requerimientos de energía para dispositivos portables son cruciales , la DE-0 Nano posee 3 esquemas posibiles
				de conexión : un puerto USB mini-AB, conectores de 2 pines para alimentacion externa de 5V, y 2 pines de 5V.
